// src/components/ui/NewDarkLayout.tsx
...
interface NewDarkLayoutProps {
  children: ReactNode
}

export default function NewDarkLayout({ children }: NewDarkLayoutProps) {
  ...
  return (
    <div className={`min-h-screen flex ${inter.className}`}>
      {/* Dark Sidebar */}
      <aside className="w-64 bg-gray-900 flex-shrink-0 h-screen sticky top-0 flex flex-col">
        {/* Logo */}
        <div className="p-6">
